...
terraform {
  ...
  backend "azurerm" {
    ...
    storage_account_name = "tfstate119210"
...
data "azurerm_resource_group" "tfstate1" {
  name = "tfstate1"
}
output "id" {
  value = data.azurerm_resource_group.tfstate1.id
}
#####################################################################
...
module "network" {
  ...
  resource_group_name = data.azurerm_resource_group.tfstate1.name
  ...
  depends_on = [data.azurerm_resource_group.tfstate1]
}
#####################################################################
